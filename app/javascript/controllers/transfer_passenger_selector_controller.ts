...
export default class extends Controller<HTMLElement> {
  ...
  declare readonly passengerNameInputTarget: HTMLInputElement
  declare readonly passengerPhoneInputTarget: HTMLInputElement
  ...
  connect(): void {
    console.log("TransferPassengerSelector connected")
  }

  // Open modal
  openModal(): void {
    console.log("Opening transfer passenger selector modal")
  ...
  togglePassenger(event: Event): void {
    ...
    if (checkbox.checked) {
      ...
      // Update form inputs
      this.passengerNameInputTarget.value = passengerName
      this.passengerPhoneInputTarget.value = passengerPhone
      ...
      // Clear form inputs
      this.passengerNameInputTarget.value = ''
      this.passengerPhoneInputTarget.value = ''
