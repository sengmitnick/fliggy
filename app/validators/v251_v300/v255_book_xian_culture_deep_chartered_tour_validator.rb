...
# V255: 给陈静预订后天西安文化深度游包车（经济5座，6小时）
#
# 任务描述:
#   陈静计划后天在西安进行文化深度游，需要预订包车服务。
#   要求选择经济5座车型，包车时长6小时（半日游标准服务时长）。
...
module V251V300
  class V255BookXianCultureDeepCharteredTourValidator < BaseValidator
    ...
    self.title = '给陈静预订后天西安文化深度游包车（经济5座，6小时）'
    self.description = '给陈静预订后天西安文化深度游包车（经济5座，6小时）'
