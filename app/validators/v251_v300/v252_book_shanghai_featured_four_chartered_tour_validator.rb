...
# V252: 给王芳等12人预订7天后上海精华四景包车（商务巴士，8小时）
#
# 任务描述:
#   王芳等12人计划7天后在上海进行精华四景游，需要预订包车服务。
#   要求选择商务巴士车型，包车时长8小时（一日游标准服务时长）。
...
#   5. 填写出发日期（7天后）、联系人信息（王芳）
#   6. 提交订单并验证价格计算正确性
#
# 复杂度分析（5个关键点）：
#   1. 需要理解路线筛选：路线名包含"精华四景"
#   2. 需要理解车型选择：商务巴士（适合12人团队）
#   3. 需要理解服务时长：8小时（一日游标准服务时长）
#   4. 需要理解出发日期计算：7天后（Date.current + 7.days）
#   5. 需要理解联系人选择：王芳（团队领队）及其电话号码
...
module V251V300
  class V252BookShanghaiFeaturedFourCharteredTourValidator < BaseValidator
    ...
    self.title = '给王芳等12人预订7天后上海精华四景包车（商务巴士，8小时）'
    self.description = '给王芳等12人预订7天后上海精华四景包车（商务巴士，8小时）'
