...
module V301V350
  class V305BookFamilyEducationTourValidator < BaseValidator
    ...
    self.title = '给刘强、陈静和小明预订北京亲子教育游（12天后，2大1小，≥2天）'
    ...
    def prepare
      ...
      # Pre-query existing passengers from demo_user
      ...
      # Expected contact info (use adult as primary contact)
    ...
    def verify
      ...
      add_assertion "预订2大1小组合", weight: 15 do
