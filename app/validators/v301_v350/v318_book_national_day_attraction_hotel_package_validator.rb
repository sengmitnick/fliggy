...
# 验证用例318: 预订张家界国家森林公园门票+武陵源度假酒店（刘强、陈静，7天后，2人，2张成人票+豪华双床房2晚）
#
# 任务描述:
#   刘强和陈静预订7天后去张家界旅游。
#   要求：张家界国家森林公园门票（2张成人票）+ 张家界武陵源度假酒店豪华双床房（7天后入住，2晚，1间房，2人）。
#   Agent 需要创建两个订单：
#   1) 景区门票订单（TicketOrder）- 张家界国家森林公园成人票，2张
#   2) 酒店订单（HotelBooking）- 张家界武陵源度假酒店豪华双床房，2晚
#   联系人使用刘强或陈静的信息。
#
# 业务流程（7个关键步骤）：
#   1. 搜索张家界国家森林公园景区
#   2. 查找普通成人票（ticket_type: 'adult'）
#   3. 搜索张家界武陵源度假酒店
#   4. 查找豪华双床房房型
#   5. 确定日期（门票游玩日期为7天后，酒店入住7天后、2晚）
#   6. 创建门票订单（2张成人票，游客信息为刘强+陈静）
#   7. 创建酒店订单（1间豪华双床房，2晚，2成人）
#
# 复杂度分析（7个关键点）：
#   1. 需要创建两个独立订单：TicketOrder（门票）+ HotelBooking（酒店）
#   2. 需要准确匹配景区名称（张家界国家森林公园）和城市（张家界）
#   3. 需要准确匹配酒店名称（张家界武陵源度假酒店）和房型（豪华双床房）
#   4. 需要验证门票游客信息（2人：刘强+陈静）
#   5. 需要正确计算日期（游玩日期、7天后；酒店入住：7天后至2晚）
#   6. 需要选择demo用户的乘客（刘强或陈静）作为联系人
#   7. 需要计算酒店价格（房间单价 * 2晚 * 1间房）
#
# 评分标准（12项，总计100%）:
...
module V301V350
  class V318BookNationalDayAttractionHotelPackageValidator < BaseValidator
    ...
    self.title = '预订张家界国家森林公园门票+武陵源度假酒店（刘强、陈静，7天后，2人，2张成人票+豪华双床房2晚）'
    self.description = '预订7天后去张家界旅游，刘强和陈静，2人，需要张家界国家森林公园成人票（2张）和张家界武陵源度假酒店豪华双床房（7天后入住，2晚，1间房）'
