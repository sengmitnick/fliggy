...
# V319: 给张三预订15天后北京到三亚的往返机票（去程15天后、返程20天后），以及三亚亚龙湾亲子度假酒店亲子家庭房（入住5晚，2成人+1儿童，酒店入住日期与航班衔接）
#
# 任务描述:
#   给张三预订15天后北京到三亚的往返机票（去程15天后、返程20天后），以及三亚亚龙湾亲子度假酒店亲子家庭房（入住5晚，2成人+1儿童，酒店入住日期与航班衔接）
#
# 评分标准:
#   - 创建了往返机票订单 (12%)
...
module V301V350
  class V319BookSummerVacationFamilyTourValidator < BaseValidator
    ...
    self.title = '给张三预订15天后北京到三亚的往返机票（去程15天后、返程20天后），以及三亚亚龙湾亲子度假酒店亲子家庭房（入住5晚，2成人+1儿童，酒店入住日期与航班衔接）'
    self.description = "给张三预订15天后北京到三亚的往返机票（去程15天后、返程20天后），以及三亚亚龙湾亲子度假酒店亲子家庭房（入住5晚，2成人+1儿童，酒店入住日期与航班衔接）"
