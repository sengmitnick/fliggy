...
# 验证用例66: 给张三购买泰国流量包（泰国、语音包类型、100分钟）
# 
# 任务描述:
...
module V051V100
  class V066BuyThailandDataPlan1dayValidator < BaseValidator
    ...
    self.title = '给张三购买泰国流量包（泰国、语音包类型、100分钟）'
    self.description = '购买泰国流量包（泰国、语音包类型、100分钟）'
    ...
    def prepare
      ...
      # 返回给 Agent 的任务信息
      {
        task: "给张三购买泰国流量包（语音包、100分钟）",
        region: @region,
        data_limit: @data_limit,
        quantity: @quantity,
        hint: "泰国语音包流量包选项: 100分钟(68元)、200分钟(118元)、500分钟(268元)。选择100分钟套餐，68元",
    ...
    def verify
      ...
      # 断言4: 选择了泰国语音包流量包
      add_assertion "选择了泰国语音包流量包", weight: 20 do
