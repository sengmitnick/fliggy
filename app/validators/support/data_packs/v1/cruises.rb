...
cruise_routes_data = [
  { name: '日韩', region: 'japan_korea', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '三峡', region: 'yangtze_river', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '南北极', region: 'north_pole', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '东南亚', region: 'southeast_asia', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '地中海', region: 'mediterranean', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '阿拉斯加', region: 'alaska', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '欧洲河轮', region: 'europe_river', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '加勒比', region: 'caribbean', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '中东', region: 'middle_east', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current },
  { name: '西沙群岛', region: 'xisha_islands', icon_url: ImageSeedHelper.random_image_from_category(:cruise_destinations), created_at: Time.current, updated_at: Time.current }
]
