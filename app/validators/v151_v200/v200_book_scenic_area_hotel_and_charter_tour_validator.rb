...
# 使用方法:
#   # 准备阶段
#   POST /api/tasks/v506_book_scenic_area_hotel_and_charter_tour_validator/start
#   
#   # Agent 通过界面操作完成任务...
#   
#   # 验证结果
...
module V151V200
  class V200BookScenicAreaHotelAndCharterTourValidator < BaseValidator
    self.validator_id = 'v200_book_scenic_area_hotel_and_charter_tour_validator'
    self.task_id = 'ca463fe3-645e-45d7-85f6-95ce2b67861b'
