...
# 验证用例178: 预订杭州经典一日游（舒适5座，商务出行，明天出发）
#
# 核心验证点:
# 1. 路线选择: 杭州经典一日游
# 2. 车型选择: 舒适5座（座位数≥3人）
...
module V151V200
  class V178BookHangzhouClassicOneDayCharteredTourValidator < BaseValidator
    self.validator_id = 'v178_book_hangzhou_classic_one_day_chartered_tour_validator'
