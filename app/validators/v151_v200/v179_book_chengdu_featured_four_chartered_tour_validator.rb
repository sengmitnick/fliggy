...
# 验证用例179: 预订成都精华四景游（舒适7座，朋友出行，10天后出发）
#
# 核心验证点:
# 1. 路线选择: 成都精华四景
# 2. 车型选择: 舒适7座（座位数≥6人）
...
module V151V200
  class V179BookChengduFeaturedFourCharteredTourValidator < BaseValidator
    self.validator_id = 'v179_book_chengdu_featured_four_chartered_tour_validator'
