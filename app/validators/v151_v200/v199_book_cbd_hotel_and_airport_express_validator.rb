...
# 使用方法:
#   # 准备阶段
#   POST /api/tasks/v505_book_cbd_hotel_and_airport_express_validator/start
#   
#   # Agent 通过界面操作完成任务...
#   
#   # 验证结果
...
module V151V200
  class V199BookCbdHotelAndAirportExpressValidator < BaseValidator
    self.validator_id = 'v199_book_cbd_hotel_and_airport_express_validator'
    self.task_id = 'fb94c969-19fb-46b2-8aad-018883825e33'
