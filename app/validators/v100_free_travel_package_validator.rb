...
# 验证用例100: 预订自由行套餐（上海3天2晚）
#
# 任务描述:
#   预订上海自由行套餐，3天2晚，2成人，包含机票酒店
#
# 评分标准:
#   - 订单已创建 (25分)
#   - 目的地正确（上海）(15分)
...
# 使用方法:
#   # 准备阶段
#   POST /api/tasks/v100_free_travel_package_validator/start
#   
#   # Agent 通过界面操作完成任务...
#   
#   # 验证结果
#   POST /api/verify/:execution_id/result
class V100FreeTravelPackageValidator < BaseValidator
  self.validator_id = 'v100_free_travel_package_validator'
