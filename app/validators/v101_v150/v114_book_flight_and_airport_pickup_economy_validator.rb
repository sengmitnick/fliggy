...
# 使用方法:
#   # 准备阶段
#   POST /api/tasks/v114_book_flight_and_airport_pickup_economy_validator/start
#   
#   # Agent 通过界面操作完成任务...
#   
#   # 验证结果
...
module V101V150
  class V114BookFlightAndAirportPickupEconomyValidator < BaseValidator
    self.validator_id = 'v114_book_flight_and_airport_pickup_economy_validator'
