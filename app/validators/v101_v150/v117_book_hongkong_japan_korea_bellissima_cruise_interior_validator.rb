...
# 验证用例117: 给张三、李四预订日韩邮轮（地中海辉煌号，香港出发，7天6晚，内舱房，3月份最近的班次）
#
# 任务描述:
#   用户想预订日韩邮轮，为2位成人（张三、李四）。
#   要求地中海辉煌号，行程7天6晚，从香港出发，选择3月份最近的一个班次，预订内舱房（性价比之选）。
...
#   6. 预订内舱房（category='interior'），为2位成人，填写2位成人的出行信息，联系人从出行人中选择
#
# 复杂度分析（6个关键点）：
...
module V101V150
  class V117BookHongkongJapanKoreaBellissimaCruiseInteriorValidator < BaseValidator
    ...
    self.title = '给张三、李四预订日韩邮轮（地中海辉煌号，香港出发，7天6晚，内舱房，3月份最近的班次）'
    self.description = '预订日韩邮轮（地中海辉煌号，7天6晚，香港出发，3月出发）'
