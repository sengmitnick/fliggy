...
# V116: 帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，最近班次，2间海景房）
#
# 任务描述:
#   用户需要为陈静预订东南亚邮轮服务，包含：
#   1) 邮轮订单（CruiseOrder，爱达新星号，上海出发）
#   2) 行程要求（9天8晚，3月份最近的班次）
#   3) 舱房类型（海景房 ocean_view，2间）
#   4) 乘客人数（2位成人）
...
module V101V150
  class V116BookShanghaiSoutheastAsiaNovaCruiseOceanviewValidator < BaseValidator
    ...
    self.title = '帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，最近班次，2间海景房）'
    self.description = '帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，最近班次，2间海景房）'
