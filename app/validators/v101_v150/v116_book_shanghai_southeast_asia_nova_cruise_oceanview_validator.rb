...
# V116: 帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，2间海景房）
#
# 任务描述:
#   用户需要为陈静预订东南亚邮轮服务，包含：
...
#   4) 乘客人数（2位成人）
#   确保船只、出发港、行程天数、出发月份、舱房类型和预订数量正确
#
# 评分标准:
#   - 创建了邮轮订单（爱达新星号） (20%)
#   - 船只正确（爱达新星号） (15%)
...
module V101V150
  class V116BookShanghaiSoutheastAsiaNovaCruiseOceanviewValidator < BaseValidator
    ...
    self.title = '帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，2间海景房）'
    self.description = '帮陈静预订3月份上海出发的爱达新星号东南亚邮轮（9天8晚，2间海景房）'
