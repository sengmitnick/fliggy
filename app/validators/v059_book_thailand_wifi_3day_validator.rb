...
class V059BookThailandWifi3dayValidator < BaseValidator
  ...
  def prepare
    ...
    # 返回给 Agent 的任务信息
    {
      task: "请预订一台泰国4G经济版WiFi，租用3天",
      region: @region,
      rental_days: @rental_days,
      quantity: @quantity,
      wifi_type: @wifi_keyword,
      hint: "泰国有多款WiFi可选，选择4G经济版（9元/天）。租赁: 1台×3天+押金500=527元。取件: 7天后、上海市浦东新区世纪大道1000号、邮寄。联系人: 李四/13900139000",
  ...
  def verify
    ...
    # 断言4: 选择了泰国4G经济版WiFi
    add_assertion "选择了泰国4G经济版WiFi", weight: 25 do
