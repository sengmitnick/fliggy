...
# 使用方法:
#   # 准备阶段
#   POST /api/tasks/v101_private_group_booking_validator/start
#   
#   # Agent 通过界面操作完成任务...
#   
#   # 验证结果
#   POST /api/verify/:execution_id/result
class V101PrivateGroupBookingValidator < BaseValidator
  self.validator_id = 'v101_private_group_booking_validator'
